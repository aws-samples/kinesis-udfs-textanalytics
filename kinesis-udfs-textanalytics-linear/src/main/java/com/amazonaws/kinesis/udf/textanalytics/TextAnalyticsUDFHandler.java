...
public class TextAnalyticsUDFHandler 
{
    ...
    public TextAnalyticsUDFHandler(ComprehendClient comprehendClient, TranslateClient translateClient) {
        System.out.println("Initializing TextAnalyticsUDFHandler with overloaded clients from notebook");
        this.comprehendClient = comprehendClient;
        this.translateClient = translateClient;
    }

    /**
     * Legacy methods to define AWS Client Configuration from JAR
    ...
    */
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(textAnalyticsUDFHandler.detect_dominant_language(text));
        text = "Je m'appelle Bob I am";
        System.out.println(textAnalyticsUDFHandler.detect_dominant_language_all(text));

        System.out.println("\nDETECT SENTIMENT");
        text = "I am happy";
        String lang = "en";
        System.out.println(textAnalyticsUDFHandler.detect_sentiment(text, lang));
        System.out.println(textAnalyticsUDFHandler.detect_sentiment_all(text, lang));
        text = "She is sad";
        lang = "en";
        System.out.println(textAnalyticsUDFHandler.detect_sentiment(text, lang));
        System.out.println(textAnalyticsUDFHandler.detect_sentiment_all(text, lang));
        ...
        text = "I am Bob";
        System.out.println(textAnalyticsUDFHandler.translate_text(text, sourcelang, targetlang, terminologyNames));
        ...
        text = "I am Bob";
        lang = "en";
        System.out.println(textAnalyticsUDFHandler.detect_entities(text, lang));
        System.out.println(textAnalyticsUDFHandler.detect_entities_all(text, lang));
        System.out.println(textAnalyticsUDFHandler.redact_entities(text, lang, "ALL"));
        ...
        text = "I am Bob";
        lang = "en";
        System.out.println(textAnalyticsUDFHandler.detect_pii_entities(text, lang));
        System.out.println(textAnalyticsUDFHandler.detect_pii_entities_all(text, lang));
        System.out.println(textAnalyticsUDFHandler.redact_pii_entities(text, lang, "ALL"));
